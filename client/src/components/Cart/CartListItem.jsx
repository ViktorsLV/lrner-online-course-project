...
const CartListItem = ({ title, mainImage, author, hours, lessons, price, id, reviewCount, likes, users, tags, category, slug }) => {
    ...
    return (
        <div className='border group overflow-hidden w-full flex my-3 rounded-md'>
            {mainImage ? <img src={urlFor(mainImage).url()} alt="Post " className='w-2/5 md:w-1/4 object-cover cursor-pointer ' onClick={()=>goToCourse(slug)}/> :
                <img src={fakeImage} alt="Fake post " className='h-30 w-1/4 object-cover cursor-pointer'/>
            }
            <div className='flex justify-between w-full p-3 bg-primary-500 flex-col md:flex-row'>
                <div className='flex flex-col'>
                    ...
                    <div className='space-x-5 mt-2 hidden md:flex'>
                        <div className='flex'>
                ...
                <div className='flex space-x-20 mt-3 md:m-0'>
